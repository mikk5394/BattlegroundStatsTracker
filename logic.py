...
class HeroSelectedWindow:
    def __init__(self, master, hero_id):
        ...
        bg = Image.open(r"C:\Users\Mikke\PycharmProjects\BattlegroundStats\background.png")
        w, h = bg.size
...
def main():
    ...
    for img_name in glob.glob(path + "/*.png"):
        ...
        img = img.resize((int(w / 4), int(h / 4)), Image.ANTIALIAS)  # resizes the picture to make the buttons smaller
